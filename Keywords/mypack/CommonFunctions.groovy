...
class CommonFunctions{
	...
	@Keyword
	def verifyLoginFeature() {
		if (WebUI.getUrl().contains('inventory')) {
	...
	def openBrowser(){
		...
		WebUI.verifyMatch(WebUI.getWindowTitle(), 'Swag Labs', true)
		println("Webpage title is:- "+WebUI.getWindowTitle())
	}


	def enterUserDetails(String firstName, String lastName, String zipCode, String info){
		println(info)
